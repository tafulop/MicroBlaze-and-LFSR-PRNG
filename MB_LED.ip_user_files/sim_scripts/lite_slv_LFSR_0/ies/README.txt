...
#
# Generated by export_simulation on Mon Jan 04 16:54:17 CET 2016
#
################################################################################
...
switch to the './lite_slv_LFSR_0.sh' script.

./lite_slv_LFSR_0.sh -reset_run
...
./lite_slv_LFSR_0.sh -noclean_files

For more information on the script, please type './lite_slv_LFSR_0.sh -help'.
