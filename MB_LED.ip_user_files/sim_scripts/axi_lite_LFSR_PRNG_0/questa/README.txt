...
#
# Generated by export_simulation on Tue Jan 05 13:31:53 CET 2016
#
################################################################################
...
switch to the './axi_lite_LFSR_PRNG_0.sh' script.

./axi_lite_LFSR_PRNG_0.sh -reset_run
...
./axi_lite_LFSR_PRNG_0.sh -noclean_files

For more information on the script, please type './axi_lite_LFSR_PRNG_0.sh -help'.
