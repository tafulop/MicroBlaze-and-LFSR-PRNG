...
HD_PWD='/mnt/seagate/Development/FPGA/MB_LED/MB_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_gpio_led_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source design_gpio_led_wrapper.tcl
