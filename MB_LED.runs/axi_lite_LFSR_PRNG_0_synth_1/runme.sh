...
HD_PWD='/mnt/seagate/Development/FPGA/MB_LED/MB_LED.runs/axi_lite_LFSR_PRNG_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_lite_LFSR_PRNG_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source axi_lite_LFSR_PRNG_0.tcl
