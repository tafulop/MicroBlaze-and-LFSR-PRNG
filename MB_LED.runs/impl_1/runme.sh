...
HD_PWD='/mnt/seagate/Development/FPGA/MB_LED/MB_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_gpio_led_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source design_gpio_led_wrapper.tcl -notrace
